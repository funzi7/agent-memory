...
- **Last commit:** `d8ba47f` (Group Q prime — equity-% uses combinedTotalRealized, removed duplicate dashboard target banner, social toggle moved onto header row, cleared remaining AI/sector analysis leak in edit screen)
