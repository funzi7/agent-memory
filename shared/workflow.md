...
Device-test flow UPDATED: Claude Code writes tests in ENGLISH with Hebrew on-screen area names; Claude (Desktop) translates them to proper Hebrew in chat and Dima answers there (the Windows terminal cannot render RTL).
